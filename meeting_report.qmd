...
There are 14 questions that we asked survey respondents regarding their negative beliefs about urban trees. They are as follows (significant relationships will be visualized below):
...
2.  Hiên and Emile consult if the variables selected make sense, and if so, what our predictions are

3.  All decide if we want to incorporate street tree cover into the model

4.  Bella finalizes models + finds better way to visualize/present outputs
